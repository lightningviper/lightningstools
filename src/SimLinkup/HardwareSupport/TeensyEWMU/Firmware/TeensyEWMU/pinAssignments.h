...
const uint8_t MODE_OFF_PIN = 48; //28;
...
const uint8_t JETTISON_PIN = 47; //0;
...
const uint8_t EWMU_PUSHBUTTON_MATRIX_COL3_PIN = 28; //38;
const uint8_t EWMU_PUSHBUTTON_MATRIX_COL4_PIN = 39;
const uint8_t EWMU_PUSHBUTTON_MATRIX_ROW1_PIN = 33;
const uint8_t EWMU_PUSHBUTTON_MATRIX_ROW2_PIN = 0; //34;
...
const uint8_t EWPI_BRIGHTNESS_POT_PIN = IS_EWMU_AND_EWPI_DAISY_CHAINED ? EWMU_AND_CMDS_BRIGHTNESS_POT_PIN : EWMU_AND_CMDS_BRIGHTNESS_POT_PIN; //16;
...
const uint8_t UNK_BUTTON_PIN = 16; //20;
