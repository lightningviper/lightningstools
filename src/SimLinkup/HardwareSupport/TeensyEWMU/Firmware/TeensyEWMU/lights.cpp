...
void setupLightOutputsForCMDS() {
  ...
  analogWriteFrequency(CMDS_NOGO_ANNUNCIATOR_PIN, PWM_LIGHTING_FREQUENCY_HZ);   
  pinMode(CMDS_GO_ANNUNCIATOR_PIN, OUTPUT); 
  analogWriteFrequency(CMDS_GO_ANNUNCIATOR_PIN, PWM_LIGHTING_FREQUENCY_HZ);
  pinMode(CMDS_DISPENSE_RDY_ANNUNCIATOR_PIN, OUTPUT); 
  analogWriteFrequency(CMDS_DISPENSE_RDY_ANNUNCIATOR_PIN, PWM_LIGHTING_FREQUENCY_HZ);
...
void setupLightOutputsForEWPI() {
  ...
  analogWriteFrequency(PRI_LED_PIN, PWM_LIGHTING_FREQUENCY_HZ);   
  pinMode(UNK_LED_PIN, OUTPUT); 
  analogWriteFrequency(UNK_LED_PIN, PWM_LIGHTING_FREQUENCY_HZ);   
  pinMode(ML_LED_PIN, OUTPUT); 
  analogWriteFrequency(ML_LED_PIN, PWM_LIGHTING_FREQUENCY_HZ);   
