...
namespace LightningGauges.Renderers.F16.RWR.ALR67
{
    public class RWRScopeALR67Renderer : RWRRenderer
    {
        ...
        public override void Render(DrawingContext drawingContext)
        {
            ...
            {
                DrawTextCenteredVertical(drawingContext, "N", -TextWidth("M", false), TextHeight(false) * 0.5, false);
            }

            if (RwrInfoContains("llbl"))
            {
                DrawTextCenteredVertical(drawingContext, "L", TextWidth("L", false), TextHeight(false) * 0.5, false);
            }

            if (RwrInfoContains("blbl"))
            {
                DrawTextCenteredVertical(drawingContext, "B", 0, -TextHeight(false) * 0.5, false);
            }
        }
