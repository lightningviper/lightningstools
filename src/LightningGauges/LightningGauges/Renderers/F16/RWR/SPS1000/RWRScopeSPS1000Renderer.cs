...
namespace LightningGauges.Renderers.F16.RWR.SPS1000
{
    public class RWRScopeSPS1000Renderer : RWRRenderer
    {
        ...
        public RWRScopeSPS1000Renderer()
        {
        ...
        public override void Render(DrawingContext drawingContext)
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                double y = 0.6 * Math.Sin(i * (30 * DTR));
                double x = 0.6 * Math.Cos(i * (30 * DTR));
                DrawSolidCircle(drawingContext, x, y, 0.02);
            }

            DrawCircle(drawingContext, 0, 0, 0.05);
