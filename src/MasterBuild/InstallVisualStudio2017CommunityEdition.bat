...
IF NOT EXIST "%MASTERBUILDDIR%vs_community.exe" bitsadmin /transfer VisualStudio2017CommunityEdition /priority HIGH https://aka.ms/vs/15/release/vs_community.exe "%MASTERBUILDDIR%vs_community.exe" 
